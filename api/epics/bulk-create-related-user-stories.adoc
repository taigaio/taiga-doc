...
When the creation is successful, the HTTP response is a 200 OK and the response body is a JSON list of link:#object-epic-related-user-story-detail[epic related user story detail object]
