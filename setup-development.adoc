...
apt install -y automake libtool libffi-dev libssl-dev curl git tmux gettext
----
...
apt install -y postgresql-doc postgresql-server-dev-all
----
...
[source,bash]
----
apt install -y python3 python3-pip python3-virtualenv python-dev python3-dev python-pip python-virtualenv
