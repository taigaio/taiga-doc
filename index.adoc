...
the python requirements, the package lxml will use gcc for building itself and fail if there
is not enough memory.
- Taiga code doesn't nedd a lot of disc space. Only the database or the media directory could need
