...
From https://github.com/taigaio/taiga-front[taiga-front] download the file `conf/conf.example.json` and rename it:
...
[source, bash]
----
(taiga-back) pip install git+https://github.com/taigaio/taiga-contrib-protected.git@stable#egg=taiga-contrib-protected
----
