...
.Create a taiga user and virtualhost for rabbitmq
[source,bash]
----
...
an application server must be confogure first. The details for this are explained later in Section 6.1 in this doc.
