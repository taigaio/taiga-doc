...
You can add `SESSION_COOKIE_SECURE` and `CSRF_COOKIE_SECURE` to x-environment and change its value. By default is "True".
More info about this environment variables link:https://docs.djangoproject.com/en/2.1/ref/settings/[here].
