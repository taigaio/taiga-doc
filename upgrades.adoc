...
Now you should to upgrade contrib plugins, and then
...
2.1.0 > 3.0.0 (extra step for instances with gogs plugin installed)
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~

Taiga contrib gogs plugin has been moved to taiga core so in case you installed the plugin you must uninstall it:
